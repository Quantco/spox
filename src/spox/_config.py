...
Policy: when a new opset version is deemed stable enough, Spox will bump the default here.
...
def set_default_opset(op):
    """Override the default global opset module from the 'stable' choice of Spox."""
    global _default_opset
    _default_opset = op
