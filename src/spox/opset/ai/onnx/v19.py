...
from spox.opset.ai.onnx.v18 import _Abs, abs
from spox.opset.ai.onnx.v18 import _Acos, acos
from spox.opset.ai.onnx.v18 import _Acosh, acosh
from spox.opset.ai.onnx.v18 import _Add, add
from spox.opset.ai.onnx.v18 import _And, and_
from spox.opset.ai.onnx.v18 import _ArgMax, arg_max
from spox.opset.ai.onnx.v18 import _ArgMin, arg_min
from spox.opset.ai.onnx.v18 import _Asin, asin
from spox.opset.ai.onnx.v18 import _Asinh, asinh
from spox.opset.ai.onnx.v18 import _Atan, atan
from spox.opset.ai.onnx.v18 import _Atanh, atanh
from spox.opset.ai.onnx.v18 import _BatchNormalization, batch_normalization
from spox.opset.ai.onnx.v18 import _Bernoulli, bernoulli
from spox.opset.ai.onnx.v18 import _BitShift, bit_shift
from spox.opset.ai.onnx.v18 import _BitwiseAnd, bitwise_and
from spox.opset.ai.onnx.v18 import _BitwiseNot, bitwise_not
from spox.opset.ai.onnx.v18 import _BitwiseOr, bitwise_or
from spox.opset.ai.onnx.v18 import _BitwiseXor, bitwise_xor
from spox.opset.ai.onnx.v18 import _BlackmanWindow, blackman_window
from spox.opset.ai.onnx.v18 import _Ceil, ceil
from spox.opset.ai.onnx.v18 import _Celu, celu
from spox.opset.ai.onnx.v18 import _CenterCropPad, center_crop_pad
from spox.opset.ai.onnx.v18 import _Clip, clip
from spox.opset.ai.onnx.v18 import _Col2Im, col2_im
from spox.opset.ai.onnx.v18 import _Compress, compress
from spox.opset.ai.onnx.v18 import _Concat, concat
from spox.opset.ai.onnx.v18 import _ConcatFromSequence, concat_from_sequence
from spox.opset.ai.onnx.v18 import _ConstantOfShape, constant_of_shape
from spox.opset.ai.onnx.v18 import _Conv, conv
from spox.opset.ai.onnx.v18 import _ConvInteger, conv_integer
from spox.opset.ai.onnx.v18 import _ConvTranspose, conv_transpose
from spox.opset.ai.onnx.v18 import _Cos, cos
from spox.opset.ai.onnx.v18 import _Cosh, cosh
from spox.opset.ai.onnx.v18 import _CumSum, cumsum
from spox.opset.ai.onnx.v18 import _DFT, dft
from spox.opset.ai.onnx.v18 import _DepthToSpace, depth_to_space
from spox.opset.ai.onnx.v18 import _Det, det
from spox.opset.ai.onnx.v18 import _Div, div
from spox.opset.ai.onnx.v18 import _Dropout, dropout
from spox.opset.ai.onnx.v18 import _DynamicQuantizeLinear, dynamic_quantize_linear
from spox.opset.ai.onnx.v18 import _Einsum, einsum
from spox.opset.ai.onnx.v18 import _Elu, elu
from spox.opset.ai.onnx.v18 import _Erf, erf
from spox.opset.ai.onnx.v18 import _Exp, exp
from spox.opset.ai.onnx.v18 import _Expand, expand
from spox.opset.ai.onnx.v18 import _EyeLike, eye_like
from spox.opset.ai.onnx.v18 import _Flatten, flatten
from spox.opset.ai.onnx.v18 import _Floor, floor
from spox.opset.ai.onnx.v18 import _GRU, gru
from spox.opset.ai.onnx.v18 import _Gather, gather
from spox.opset.ai.onnx.v18 import _GatherElements, gather_elements
from spox.opset.ai.onnx.v18 import _GatherND, gather_nd
from spox.opset.ai.onnx.v18 import _Gemm, gemm
from spox.opset.ai.onnx.v18 import _GlobalAveragePool, global_average_pool
from spox.opset.ai.onnx.v18 import _GlobalLpPool, global_lp_pool
from spox.opset.ai.onnx.v18 import _GlobalMaxPool, global_max_pool
from spox.opset.ai.onnx.v18 import _Greater, greater
from spox.opset.ai.onnx.v18 import _GreaterOrEqual, greater_or_equal
from spox.opset.ai.onnx.v18 import _GridSample, grid_sample
from spox.opset.ai.onnx.v18 import _GroupNormalization, group_normalization
from spox.opset.ai.onnx.v18 import _HammingWindow, hamming_window
from spox.opset.ai.onnx.v18 import _HannWindow, hann_window
from spox.opset.ai.onnx.v18 import _HardSigmoid, hard_sigmoid
from spox.opset.ai.onnx.v18 import _HardSwish, hard_swish
from spox.opset.ai.onnx.v18 import _Hardmax, hardmax
from spox.opset.ai.onnx.v18 import _InstanceNormalization, instance_normalization
from spox.opset.ai.onnx.v18 import _IsInf, isinf
from spox.opset.ai.onnx.v18 import _IsNaN, isnan
from spox.opset.ai.onnx.v18 import _LRN, lrn
from spox.opset.ai.onnx.v18 import _LSTM, lstm
from spox.opset.ai.onnx.v18 import _LayerNormalization, layer_normalization
from spox.opset.ai.onnx.v18 import _LeakyRelu, leaky_relu
from spox.opset.ai.onnx.v18 import _Less, less
from spox.opset.ai.onnx.v18 import _LessOrEqual, less_or_equal
from spox.opset.ai.onnx.v18 import _Log, log
from spox.opset.ai.onnx.v18 import _LogSoftmax, log_softmax
from spox.opset.ai.onnx.v18 import _LpNormalization, lp_normalization
from spox.opset.ai.onnx.v18 import _LpPool, lp_pool
from spox.opset.ai.onnx.v18 import _MatMul, matmul
from spox.opset.ai.onnx.v18 import _MatMulInteger, matmul_integer
from spox.opset.ai.onnx.v18 import _Max, max
from spox.opset.ai.onnx.v18 import _MaxPool, max_pool
from spox.opset.ai.onnx.v18 import _MaxRoiPool, max_roi_pool
from spox.opset.ai.onnx.v18 import _MaxUnpool, max_unpool
from spox.opset.ai.onnx.v18 import _Mean, mean
from spox.opset.ai.onnx.v18 import _MeanVarianceNormalization, mean_variance_normalization
from spox.opset.ai.onnx.v18 import _MelWeightMatrix, mel_weight_matrix
from spox.opset.ai.onnx.v18 import _Min, min
from spox.opset.ai.onnx.v18 import _Mish, mish
from spox.opset.ai.onnx.v18 import _Mod, mod
from spox.opset.ai.onnx.v18 import _Mul, mul
from spox.opset.ai.onnx.v18 import _Multinomial, multinomial
from spox.opset.ai.onnx.v18 import _Neg, neg
from spox.opset.ai.onnx.v18 import _NegativeLogLikelihoodLoss, negative_log_likelihood_loss
from spox.opset.ai.onnx.v18 import _NonMaxSuppression, non_max_suppression
from spox.opset.ai.onnx.v18 import _NonZero, non_zero
from spox.opset.ai.onnx.v18 import _Not, not_
from spox.opset.ai.onnx.v18 import _OneHot, one_hot
from spox.opset.ai.onnx.v18 import _Optional, optional
from spox.opset.ai.onnx.v18 import _OptionalGetElement, optional_get_element
from spox.opset.ai.onnx.v18 import _OptionalHasElement, optional_has_element
from spox.opset.ai.onnx.v18 import _Or, or_
from spox.opset.ai.onnx.v18 import _PRelu, prelu
from spox.opset.ai.onnx.v18 import _Pow, pow
from spox.opset.ai.onnx.v18 import _QLinearConv, qlinear_conv
from spox.opset.ai.onnx.v18 import _QLinearMatMul, qlinear_matmul
from spox.opset.ai.onnx.v18 import _RNN, rnn
from spox.opset.ai.onnx.v18 import _RandomNormal, random_normal
from spox.opset.ai.onnx.v18 import _RandomNormalLike, random_normal_like
from spox.opset.ai.onnx.v18 import _RandomUniform, random_uniform
from spox.opset.ai.onnx.v18 import _RandomUniformLike, random_uniform_like
from spox.opset.ai.onnx.v18 import _Range, range
from spox.opset.ai.onnx.v18 import _Reciprocal, reciprocal
from spox.opset.ai.onnx.v18 import _ReduceL1, reduce_l1
from spox.opset.ai.onnx.v18 import _ReduceL2, reduce_l2
from spox.opset.ai.onnx.v18 import _ReduceLogSum, reduce_log_sum
from spox.opset.ai.onnx.v18 import _ReduceLogSumExp, reduce_log_sum_exp
from spox.opset.ai.onnx.v18 import _ReduceMax, reduce_max
from spox.opset.ai.onnx.v18 import _ReduceMean, reduce_mean
from spox.opset.ai.onnx.v18 import _ReduceMin, reduce_min
from spox.opset.ai.onnx.v18 import _ReduceProd, reduce_prod
from spox.opset.ai.onnx.v18 import _ReduceSum, reduce_sum
from spox.opset.ai.onnx.v18 import _ReduceSumSquare, reduce_sum_square
from spox.opset.ai.onnx.v18 import _Relu, relu
from spox.opset.ai.onnx.v18 import _ReverseSequence, reverse_sequence
from spox.opset.ai.onnx.v18 import _RoiAlign, roi_align
from spox.opset.ai.onnx.v18 import _Round, round
from spox.opset.ai.onnx.v18 import _STFT, stft
from spox.opset.ai.onnx.v18 import _ScatterElements, scatter_elements
from spox.opset.ai.onnx.v18 import _ScatterND, scatter_nd
from spox.opset.ai.onnx.v18 import _Selu, selu
from spox.opset.ai.onnx.v18 import _SequenceAt, sequence_at
from spox.opset.ai.onnx.v18 import _SequenceConstruct, sequence_construct
from spox.opset.ai.onnx.v18 import _SequenceEmpty, sequence_empty
from spox.opset.ai.onnx.v18 import _SequenceErase, sequence_erase
from spox.opset.ai.onnx.v18 import _SequenceInsert, sequence_insert
from spox.opset.ai.onnx.v18 import _SequenceLength, sequence_length
from spox.opset.ai.onnx.v18 import _SequenceMap, sequence_map
from spox.opset.ai.onnx.v18 import _Shrink, shrink
from spox.opset.ai.onnx.v18 import _Sigmoid, sigmoid
from spox.opset.ai.onnx.v18 import _Sign, sign
from spox.opset.ai.onnx.v18 import _Sin, sin
from spox.opset.ai.onnx.v18 import _Sinh, sinh
from spox.opset.ai.onnx.v18 import _Slice, slice
from spox.opset.ai.onnx.v18 import _Softmax, softmax
from spox.opset.ai.onnx.v18 import _SoftmaxCrossEntropyLoss, softmax_cross_entropy_loss
from spox.opset.ai.onnx.v18 import _Softplus, softplus
from spox.opset.ai.onnx.v18 import _Softsign, softsign
from spox.opset.ai.onnx.v18 import _SpaceToDepth, space_to_depth
from spox.opset.ai.onnx.v18 import _Split, split
from spox.opset.ai.onnx.v18 import _SplitToSequence, split_to_sequence
from spox.opset.ai.onnx.v18 import _Sqrt, sqrt
from spox.opset.ai.onnx.v18 import _Squeeze, squeeze
from spox.opset.ai.onnx.v18 import _StringNormalizer, string_normalizer
from spox.opset.ai.onnx.v18 import _Sub, sub
from spox.opset.ai.onnx.v18 import _Sum, sum
from spox.opset.ai.onnx.v18 import _Tan, tan
from spox.opset.ai.onnx.v18 import _Tanh, tanh
from spox.opset.ai.onnx.v18 import _TfIdfVectorizer, tf_idf_vectorizer
from spox.opset.ai.onnx.v18 import _ThresholdedRelu, thresholded_relu
from spox.opset.ai.onnx.v18 import _Tile, tile
from spox.opset.ai.onnx.v18 import _TopK, top_k
from spox.opset.ai.onnx.v18 import _Transpose, transpose
from spox.opset.ai.onnx.v18 import _Trilu, trilu
from spox.opset.ai.onnx.v18 import _Unique, unique
from spox.opset.ai.onnx.v18 import _Unsqueeze, unsqueeze
from spox.opset.ai.onnx.v18 import _Where, where
from spox.opset.ai.onnx.v18 import _Xor, xor
...
def average_pool(X: Var, *,     auto_pad: str = "NOTSET",     ceil_mode: int = 0,     count_include_pad: int = 0,     dilations: Optional[Iterable[int]] = None,     kernel_shape: Iterable[int],     pads: Optional[Iterable[int]] = None,     strides: Optional[Iterable[int]] = None, ) -> Var:
    r"""
...
def deform_conv(X: Var, W: Var, offset: Var, B: Optional[Var] = None, mask: Optional[Var] = None, *,     dilations: Optional[Iterable[int]] = None,     group: int = 1,     kernel_shape: Optional[Iterable[int]] = None,     offset_group: int = 1,     pads: Optional[Iterable[int]] = None,     strides: Optional[Iterable[int]] = None, ) -> Var:
    r"""
...
Type constraints:
 - T: `tensor(double)`, `tensor(float)`, `tensor(float16)`
    ...
    X=unwrap_vars(X), W=unwrap_vars(W), offset=unwrap_vars(offset), B=unwrap_vars(B), mask=unwrap_vars(mask),     ), ).get_output_vars(
    X=get_value(X), W=get_value(W), offset=get_value(offset), B=get_value(B), mask=get_value(mask),     ).Y
...
def quantize_linear(x: Var, y_scale: Var, y_zero_point: Optional[Var] = None, *,     axis: int = 1,     saturate: int = 1, ) -> Var:
    r"""
...
Type constraints:
 ...
 - T2: `tensor(double)`, `tensor(float)`, `tensor(float16)`
    ...
    return _Resize(
        ...
        keep_aspect_ratio_policy=AttrString(keep_aspect_ratio_policy, name="keep_aspect_ratio_policy"),
        mode=AttrString(mode, name="mode"),
