...
from spox.opset.ai.onnx.ml.v4 import _ArrayFeatureExtractor, array_feature_extractor
from spox.opset.ai.onnx.ml.v4 import _Binarizer, binarizer
from spox.opset.ai.onnx.ml.v4 import _CastMap, cast_map
from spox.opset.ai.onnx.ml.v4 import _CategoryMapper, category_mapper
from spox.opset.ai.onnx.ml.v4 import _DictVectorizer, dict_vectorizer
from spox.opset.ai.onnx.ml.v4 import _FeatureVectorizer, feature_vectorizer
from spox.opset.ai.onnx.ml.v4 import _Imputer, imputer
from spox.opset.ai.onnx.ml.v4 import _LabelEncoder, label_encoder
from spox.opset.ai.onnx.ml.v4 import _LinearClassifier, linear_classifier
from spox.opset.ai.onnx.ml.v4 import _LinearRegressor, linear_regressor
from spox.opset.ai.onnx.ml.v4 import _Normalizer, normalizer
from spox.opset.ai.onnx.ml.v4 import _OneHotEncoder, one_hot_encoder
from spox.opset.ai.onnx.ml.v4 import _SVMClassifier, svmclassifier
from spox.opset.ai.onnx.ml.v4 import _SVMRegressor, svmregressor
from spox.opset.ai.onnx.ml.v4 import _Scaler, scaler
from spox.opset.ai.onnx.ml.v4 import _ZipMap, zip_map
...
Type constraints:
 - T: `tensor(double)`, `tensor(float)`, `tensor(float16)`
    ...
    return _TreeEnsemble(
        ...
        membership_values=AttrTensor.maybe(membership_values, name="membership_values"),
        n_targets=AttrInt64.maybe(n_targets, name="n_targets"),
        nodes_falseleafs=AttrInt64s(nodes_falseleafs, name="nodes_falseleafs"),
        nodes_falsenodeids=AttrInt64s(nodes_falsenodeids, name="nodes_falsenodeids"),
