...
class _Normalizer(StandardNode):
    ...
    def infer_output_types(self, initializers={}) -> dict[str, Type]:
        if self.attrs.norm.value not in ("MAX", "L1", "L2"):
            raise InferenceError(f"Unknown normalisation method `{self.attrs.norm.value}`")
        return {"Y": self.inputs.X.type} if self.inputs.X.type is not None else {}
...
def array_feature_extractor(X: Var, Y: Var, ) -> Var:
    r"""
...
def binarizer(X: Var, *,     threshold: float = 0.0, ) -> Var:
    r"""
...
def cast_map(X: Var, *,     cast_to: str = "TO_FLOAT",     map_form: str = "DENSE",     max_map: int = 1, ) -> Var:
    r"""
...
def category_mapper(X: Var, *,     cats_int64s: Optional[Iterable[int]] = None,     cats_strings: Optional[Iterable[str]] = None,     default_int64: int = -1,     default_string: str = "_Unused", ) -> Var:
    r"""
...
def dict_vectorizer(X: Var, *,     int64_vocabulary: Optional[Iterable[int]] = None,     string_vocabulary: Optional[Iterable[str]] = None, ) -> Var:
    r"""
...
Type constraints:
 ...
 - T2: `tensor(double)`, `tensor(float)`, `tensor(int64)`, `tensor(string)`
    ...
    return _DictVectorizer(
        ...
        int64_vocabulary=AttrInt64s.maybe(int64_vocabulary, name="int64_vocabulary"),
        string_vocabulary=AttrStrings.maybe(string_vocabulary, name="string_vocabulary"),
        ), _DictVectorizer.Inputs(
    X=unwrap_vars(X),     ), ).get_output_vars(
    X=get_value(X),     ).Y


def feature_vectorizer(X: Sequence[Var], *,     inputdimensions: Optional[Iterable[int]] = None, ) -> Var:
    r"""
...
def imputer(X: Var, *,     imputed_value_floats: Optional[Iterable[float]] = None,     imputed_value_int64s: Optional[Iterable[int]] = None,     replaced_value_float: float = 0.0,     replaced_value_int64: int = 0, ) -> Var:
    r"""
...
Type constraints:
 - T: `tensor(double)`, `tensor(float)`, `tensor(int32)`, `tensor(int64)`
    ...
    return _Imputer(
        _Imputer.Attributes(
        imputed_value_floats=AttrFloat32s.maybe(imputed_value_floats, name="imputed_value_floats"),
        imputed_value_int64s=AttrInt64s.maybe(imputed_value_int64s, name="imputed_value_int64s"),
        replaced_value_float=AttrFloat32(replaced_value_float, name="replaced_value_float"),
        replaced_value_int64=AttrInt64(replaced_value_int64, name="replaced_value_int64"),
        ), _Imputer.Inputs(
    X=unwrap_vars(X),     ), ).get_output_vars(
    X=get_value(X),     ).Y


def label_encoder(X: Var, *,     default_float: float = -0.0,     default_int64: int = -1,     default_string: str = "_Unused",     keys_floats: Optional[Iterable[float]] = None,     keys_int64s: Optional[Iterable[int]] = None,     keys_strings: Optional[Iterable[str]] = None,     values_floats: Optional[Iterable[float]] = None,     values_int64s: Optional[Iterable[int]] = None,     values_strings: Optional[Iterable[str]] = None, ) -> Var:
    r"""
...
def linear_classifier(X: Var, *,     classlabels_ints: Optional[Iterable[int]] = None,     classlabels_strings: Optional[Iterable[str]] = None,     coefficients: Iterable[float],     intercepts: Optional[Iterable[float]] = None,     multi_class: int = 0,     post_transform: str = "NONE", ) -> tuple[Var, Var]:
    r"""
Linear classifier
...
Type constraints:
 ...
 - T2: `tensor(int64)`, `tensor(string)`
    ...
    return _LinearClassifier(
        ...
        classlabels_ints=AttrInt64s.maybe(classlabels_ints, name="classlabels_ints"),
        classlabels_strings=AttrStrings.maybe(classlabels_strings, name="classlabels_strings"),
...
def linear_regressor(X: Var, *,     coefficients: Optional[Iterable[float]] = None,     intercepts: Optional[Iterable[float]] = None,     post_transform: str = "NONE",     targets: int = 1, ) -> Var:
    r"""
...
def normalizer(X: Var, *,     norm: str = "MAX", ) -> Var:
    r"""
...
def one_hot_encoder(X: Var, *,     cats_int64s: Optional[Iterable[int]] = None,     cats_strings: Optional[Iterable[str]] = None,     zeros: int = 1, ) -> Var:
    r"""
...
def svmclassifier(X: Var, *,     classlabels_ints: Optional[Iterable[int]] = None,     classlabels_strings: Optional[Iterable[str]] = None,     coefficients: Optional[Iterable[float]] = None,     kernel_params: Optional[Iterable[float]] = None,     kernel_type: str = "LINEAR",     post_transform: str = "NONE",     prob_a: Optional[Iterable[float]] = None,     prob_b: Optional[Iterable[float]] = None,     rho: Optional[Iterable[float]] = None,     support_vectors: Optional[Iterable[float]] = None,     vectors_per_class: Optional[Iterable[int]] = None, ) -> tuple[Var, Var]:
    r"""
...
Type constraints:
 ...
 - T2: `tensor(int64)`, `tensor(string)`
    ...
    return _SVMClassifier(
        ...
        vectors_per_class=AttrInt64s.maybe(vectors_per_class, name="vectors_per_class"),
        ), _SVMClassifier.Inputs(
    X=unwrap_vars(X),     ), ).get_output_vars(
    X=get_value(X),     )._unpack_to_any()


def svmregressor(X: Var, *,     coefficients: Optional[Iterable[float]] = None,     kernel_params: Optional[Iterable[float]] = None,     kernel_type: str = "LINEAR",     n_supports: int = 0,     one_class: int = 0,     post_transform: str = "NONE",     rho: Optional[Iterable[float]] = None,     support_vectors: Optional[Iterable[float]] = None, ) -> Var:
    r"""
...
def scaler(X: Var, *,     offset: Optional[Iterable[float]] = None,     scale: Optional[Iterable[float]] = None, ) -> Var:
    r"""
...
Type constraints:
 ...
 - T2: `tensor(int64)`, `tensor(string)`
    ...
    return _TreeEnsembleClassifier(
        ...
        base_values_as_tensor=AttrTensor.maybe(base_values_as_tensor, name="base_values_as_tensor"),
        ...
        class_weights_as_tensor=AttrTensor.maybe(class_weights_as_tensor, name="class_weights_as_tensor"),
        classlabels_int64s=AttrInt64s.maybe(classlabels_int64s, name="classlabels_int64s"),
        classlabels_strings=AttrStrings.maybe(classlabels_strings, name="classlabels_strings"),
        nodes_falsenodeids=AttrInt64s.maybe(nodes_falsenodeids, name="nodes_falsenodeids"),
        nodes_featureids=AttrInt64s.maybe(nodes_featureids, name="nodes_featureids"),
        nodes_hitrates=AttrFloat32s.maybe(nodes_hitrates, name="nodes_hitrates"),
        nodes_hitrates_as_tensor=AttrTensor.maybe(nodes_hitrates_as_tensor, name="nodes_hitrates_as_tensor"),
        nodes_missing_value_tracks_true=AttrInt64s.maybe(nodes_missing_value_tracks_true, name="nodes_missing_value_tracks_true"),
        ...
        nodes_truenodeids=AttrInt64s.maybe(nodes_truenodeids, name="nodes_truenodeids"),
        nodes_values=AttrFloat32s.maybe(nodes_values, name="nodes_values"),
        nodes_values_as_tensor=AttrTensor.maybe(nodes_values_as_tensor, name="nodes_values_as_tensor"),
        post_transform=AttrString(post_transform, name="post_transform"),
...
def tree_ensemble_regressor(X: Var, *,     aggregate_function: str = "SUM",     base_values: Optional[Iterable[float]] = None,     base_values_as_tensor: Optional[np.ndarray] = None,     n_targets: Optional[int] = None,     nodes_falsenodeids: Optional[Iterable[int]] = None,     nodes_featureids: Optional[Iterable[int]] = None,     nodes_hitrates: Optional[Iterable[float]] = None,     nodes_hitrates_as_tensor: Optional[np.ndarray] = None,     nodes_missing_value_tracks_true: Optional[Iterable[int]] = None,     nodes_modes: Optional[Iterable[str]] = None,     nodes_nodeids: Optional[Iterable[int]] = None,     nodes_treeids: Optional[Iterable[int]] = None,     nodes_truenodeids: Optional[Iterable[int]] = None,     nodes_values: Optional[Iterable[float]] = None,     nodes_values_as_tensor: Optional[np.ndarray] = None,     post_transform: str = "NONE",     target_ids: Optional[Iterable[int]] = None,     target_nodeids: Optional[Iterable[int]] = None,     target_treeids: Optional[Iterable[int]] = None,     target_weights: Optional[Iterable[float]] = None,     target_weights_as_tensor: Optional[np.ndarray] = None, ) -> Var:
    r"""
...
Type constraints:
 - T: `tensor(double)`, `tensor(float)`, `tensor(int32)`, `tensor(int64)`
    ...
    return _TreeEnsembleRegressor(
        ...
        aggregate_function=AttrString(aggregate_function, name="aggregate_function"),
        base_values=AttrFloat32s.maybe(base_values, name="base_values"),
        base_values_as_tensor=AttrTensor.maybe(base_values_as_tensor, name="base_values_as_tensor"),
        ...
        target_weights_as_tensor=AttrTensor.maybe(target_weights_as_tensor, name="target_weights_as_tensor"),
        ), _TreeEnsembleRegressor.Inputs(
    X=unwrap_vars(X),     ), ).get_output_vars(
    X=get_value(X),     ).Y


def zip_map(X: Var, *,     classlabels_int64s: Optional[Iterable[int]] = None,     classlabels_strings: Optional[Iterable[str]] = None, ) -> Var:
    r"""
